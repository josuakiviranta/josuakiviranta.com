...
\cvsection{Profilo}
Ingegnere full-stack specializzato in AI, con esperienza nella realizzazione di sistemi LLM e pipeline agentiche di livello produttivo. Esperto in ingegneria del software, context engineering, sistemi di retrieval, database vettoriali e valutazione di LLM. Unisce il lavoro tecnico approfondito alla consegna di valore per il business in contesti ad alta responsabilità.
...
Ho guidato un team di quattro persone nella progettazione e nel deployment di pipeline AI agentiche su Azure al servizio di oltre 10 clienti enterprise. Ho realizzato GPT Agents ottimizzati per compiti specifici con retrieval, orchestrazione e ottimizzazione degli LLM, e ho implementato framework di valutazione strutturati per i deployment. Ho ottimizzato la latenza delle pipeline LLM e configurato pipeline CI/CD.
...
Ho diretto lo sviluppo interno di applicazioni di AI generativa e consegnato rapidamente MVP basati su LLM; ho sviluppato e lanciato \textbf{Innofactor GPT Agents} nello stesso evento nordico in cui Microsoft ha lanciato Copilot. Ho fornito consulenza sulla strategia aziendale di AI generativa, formato i colleghi sulle tecniche di AI generativa, tenuto interventi pubblici e supportato le iniziative di vendita.

\entry{Fondatore --- Pssst!}{2022 -- 2023 \textperiodcentered{} Espoo, Finlandia}
Ho costituito e guidato un team di tre persone; ho progettato e implementato una piattaforma full-stack (React, Next.js, TypeScript) per l'headhunting in crowdsourcing. Ho gestito lo sviluppo del prodotto e il marketing e acquisito la base clienti iniziale.
...
App per mettere in contatto i vicini di casa, abbinando gli utenti in base ai loro pensieri e consumi mediatici tramite vettori semantici. (React, Node.js, TypeScript, Python, Azure Cloud, Azure OpenAI, MCP)
